...
public class HackyViewPager extends ViewPager {
	...
	private OnTouchHackViewPagerListener mListener;

	public void setOnTouchHackViewPagerListener(OnTouchHackViewPagerListener listener) {
		this.mListener = listener;
	}

	public interface OnTouchHackViewPagerListener {
		void onTouchPager(MotionEvent event);
	}
