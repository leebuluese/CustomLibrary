...
public class Luban implements Handler.Callback {
    ...
    private static final int MSG_COMPRESS_COMPLETE = 3; // add 2018-1-11 09:01:41
    ...
    private File getImageCacheFile(Context context, String suffix) {
        ...
        if (TextUtils.isEmpty(mTargetDir) && null != imageCacheDir) {
    ...
    private List<Bitmap> list = new ArrayList<>(); // add 2018-1-11 09:01:36
                    ...
                    public void run() {
                        try {
                            ...
                            if (null != path) {
                                ...
                                Log.e(TAG, "normal : file size = " + (f.length() >> 10) + " kb" + " ; file name = " + f.getName());
                            }
                            ...
                            Bitmap bitmap = PhotoUtil.getBitmapFromPath3(result);
                            list.add(bitmap);
                            if (list.size() == pathSize) {
                                mHandler.sendMessage(mHandler.obtainMessage(MSG_COMPRESS_COMPLETE, list));
                            }
                        } catch (IOException e) {
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_COMPRESS_SUCCESS:
                mCompressListener.onSuccess((Bitmap) msg.obj);
                break;
            case MSG_COMPRESS_ERROR:
                mCompressListener.onError((Throwable) msg.obj);
                break;
            case MSG_COMPRESS_COMPLETE: // add 2018-1-11 09:01:55
                mCompressListener.onComplete((List<Bitmap>) msg.obj);
                break;
            default:
                break;
        }
